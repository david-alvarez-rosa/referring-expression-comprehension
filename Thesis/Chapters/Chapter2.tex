...
{---\href{https://en.wikipedia.org/wiki/W._Edwards_Deming}
  {\scshape William Edwards}\footnotemark}
}

\footnotetext{Dr.\ William Edwards Deming (October 14, 1900 -– December 20, 1993)
  was an American engineer, statistician, professor, author, lecturer, and
...
\begin{itemize}
  ...
  \begin{figure}[ht]
    ...
    \label{fig:lstm}
    \source{From \citetitle{enwiki:1005032489}}
  \end{figure}
  ...
  \myCite{cho14:learn_rnn}. Su funcionamiento se rige por el siguiente sistema
  de ecuaciones,
  \begin{equation}
    \begin{cases}
...
\subsection{Trainning: \acrlong*{bptt}}
...
\begin{figure}[p]
  ...
  \source{From \citetitle{vaswani17:atten_all_you_need}}
\end{figure}
\footnotetext{\cite{vaswani17:atten_all_you_need}}

En la actualidad existen diferentes tipos de arquitecturas basadas en esta
