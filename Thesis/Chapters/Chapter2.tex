...
\begin{figure}[ht]
  ...
  \caption[Ejemplo de topología de una \gls{cnn} (LeNet-5)]{Ejemplo de la
    topología de una \gls{cnn}. Concretamente es
    \fhref{http://yann.lecun.com/exdb/lenet/}{LeNet-5}, una red convolucional
    creada por Yann LeCun.}
  \label{fig:lenet-5}
\end{figure}
