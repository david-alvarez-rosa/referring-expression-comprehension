...
\subsection{\acl*{cnn}}\label{sec:conv-neur-netw}
...
Here explain the overfitting problem.

There are several regularization techniques to
...
\begin{equation}
  \loss(\Omega, \theta) + \text{complexity}(\theta),
\end{equation}
and where the complexity is measured using the \(L_2\) norm, i.e.,
\begin{equation}
