...
structure. They explain their method in a summarized way.
...
but it presents quite reasonable precision values. As with the rest of the
models, the precision decreases in the RefCOCO+ dataset due to the added
complexity in the \glspl{re}, as previously mentioned. Yes it is true, that
there is still a lot of room for improvement in the field of precision, but the
...
\fhref{https://recomprehension.com}{website} of this project to test for
