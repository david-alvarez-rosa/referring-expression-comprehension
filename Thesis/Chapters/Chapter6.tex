...
On this \fhref{https://recomprehension.com}{website} you can find all the
...
Responsive design is concerned with providing the user with the best possible
...
\emph{accessibility}\index{Accesibility}. With the term accessibility we refer
...
web. \myCite{berners-lee21:introd_web_acces}, \gls{w3c}\footnote{Is the main
...
that is, the \code{index.html} along with all its corresponding \acs{css} style
...
\begin{figure}[p]
  \centering
  \scalebox{.8}{\input{Figures/Tikz/Server.tex}}
