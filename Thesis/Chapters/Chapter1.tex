...
of the object to segment with \emph{other object} (\texttt{man with a cap}),
type of object + relative \emph{positioning} (\texttt{laptop on the right}) and
object description + \emph{color} distinctive (\texttt{army officer white
  suit}).
