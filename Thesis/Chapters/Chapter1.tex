...
\begin{description}
  ...
  \gls{sota} models will be discussed. \chapRef{cha:rec}
  ...
  will be compared with current \gls{sota} works. \chapRef{cha:results}
...
Finally, after the appendices, there is a \textbf{List of Acronyms}, the full
\textbf{Bibliography} and an \textbf{Alphabetical Index} to facilitate the
