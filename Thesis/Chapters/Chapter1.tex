...
that are most current\footnote{In \today, current date of the document.} in
...
of the object to segment with \emph{other object} (`` man with a cap ''), type
of object + relative \emph{positioning} (`` laptop on the right '') and object
description + \emph{color} distinctive (`` army officer white suit '').
