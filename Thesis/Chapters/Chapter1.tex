...
\drop Artificial Intelligence (\acs{ai})\index{Artificial intelligence} is one
...
\begin{figure}[ht]
  ...
  \caption[Drones employed for road safety]{Image of one of the drones that can
    be employed by the authorities in order to guarantee road safety.}\label{fig:dgt}
  \source{TODO}
\end{figure}
