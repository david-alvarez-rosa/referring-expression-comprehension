...
\lettrine{A}{rtificial Intelligence} (\acs{ai}\glsunset{ai})\index{Artificial
  intelligence} is one of the topics related to \gls{cs} that are most
current\footnote{On \today, current date of the document.} in recent years. It
has gained great importance mainly due to its applications in industry and
everyday world, such as autonomous driving.
...
\begin{description}
  ...
  \item[Appendix B] TODO b. \chapRef{cha:code}
  \item[Appendix C] TODO c. \chapRef{cha:introduction} Fix me.
\end{description}
