...
\begin{equation}
  ...
  \SI{742.5}{\hour},
\end{equation}
lo cual, suponiendo un salario de \EUR{12}/hour, hace un total del coste
\emph{personal} de,
\begin{equation}
...
\begin{remarkBox}
  Hay que tener en cuenta que esta estimación de \EUR{12}/hour es una
...
entrenar han sido cedidos por \fhref{https://vectorinstitute.ai/}{Vector
  Institute}. El servidor usado para la web ha tenido un coste aproximado de
\EUR{20}/month y se ha alquilado por un total de 2 meses. En total \EUR{40}.
...
gratuitamente). El coste total ha sido de \text{\EUR{8950}}.
