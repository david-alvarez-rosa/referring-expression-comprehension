...
\epigraphhead[75]{
  \epigraph{\itshape{}Give me six hours to chop down a tree and I will spend
...
\begin{remarkBox}
  It must be taken into account that this estimate of \EUR{12}/hour is an
...
\fhref{https://vectorinstitute.ai/}{Vector Institute}. The server used for the
web has an approximate cost of \EUR{20} / month and has been rented for a total
of 2 months. In total \EUR{40}.
