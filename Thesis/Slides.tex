...
\begin{frame}[plain]
  \centering
  \includegraphics[height=.9\textheight]{Images/Transformer.png}
\end{frame}
...
\begin{frame}{Modular Models}{Models}
  \begin{figure}
    \includegraphics[width=.65\textwidth]{Images/MattNet.png}
...
\begin{frame}{Graph Generation}{Models}
  \begin{figure}
    \includegraphics[width=.8\textwidth]{Images/Graph model.png}
...
\begin{frame}{Base Architecture}{Topology}
  \begin{figure}
    \includegraphics[width=.75\textwidth]{Images/RefVOS.png}
...
\begin{frame}{Base Architecture}{Language Encoder}
  \begin{itemize}
    \item \Acf{bert}
    \item Based on the Transformer model
    \item State of the art (even in computer vision!)
  \end{itemize}
\end{frame}
...
\begin{frame}{Model Iterations}{Loss functions: cross entropy variants}
  \begin{itemize}
    \item \Acl{wce}
    \item \Acl{bce}
  \end{itemize}
  \begin{alertblock}{Useless learning}
    \begin{itemize}
      \item Similar functions (loss objective)
      \item Small (near 0) partial derivatives
      \item Very little learning
    \end{itemize}
  \end{alertblock}
\end{frame}
...
\begin{frame}{Model Iterations}{Loss functions: Tversky Index}
  \begin{itemize}
    \item Similar results
    \item Non significant improvements
  \end{itemize}
\end{frame}

\begin{frame}{Model iterations}{Fusion strategies performance in RefCOCO dataset}
  \centering
...
\begin{frame}{Study of Succesful Samples}{Examples}
  ...
  \begin{figure}
    ...
    \begin{subfigure}[t]{.32\textwidth}
      ...
      \includegraphics[width=.8\textwidth]{Images/Player with baseball bat.jpg}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{.32\textwidth}
      \centering
      \caption{Middle player with glove}
      \includegraphics[width=.8\textwidth]{Images/Middle player with glove.jpg}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{.32\textwidth}
      \centering
      \caption{Man in the left}
      \includegraphics[width=.8\textwidth]{Images/Man in the left.jpg}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{.32\textwidth}
      ...
      \includegraphics[width=.8\textwidth]{Images/Donuts with topping.jpg}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{.32\textwidth}
      \centering
      \caption{White background donuts}
      \includegraphics[width=.8\textwidth]{Images/White background donut.jpg}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{.32\textwidth}
      \centering
      \caption{White donut left behind}
      \includegraphics[width=.8\textwidth]{Images/White donut left behind.jpg}
    \end{subfigure}
  \end{figure}
\end{frame}
...
\begin{frame}{Study of Succesful Samples}{Examples II}
  ...
  \begin{figure}
    ...
    \begin{subfigure}[t]{.3\textwidth}
      ...
      \includegraphics[width=.8\textwidth]{Images/Person in blue.jpg}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{.3\textwidth}
      \centering
      \caption{Person with watch}
      \includegraphics[width=.8\textwidth]{Images/Person with watch.jpg}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{.3\textwidth}
      \centering
      \caption{Woman}
      \includegraphics[width=.8\textwidth]{Images/Woman.jpg}
    \end{subfigure}
  \end{figure}
\end{frame}
...
\begin{frame}[plain]
  ...
  \begin{figure}
    \begin{subfigure}[t]{.32\textwidth}
      ...
      \includegraphics[width=.72\textwidth]{Images/Woman holding hair dryer.jpg}
    \end{subfigure}\hspace{.1\textwidth}
    \begin{subfigure}[t]{.32\textwidth}
      \centering
      \caption{Hair dryer}
      \includegraphics[width=.72\textwidth]{Images/Hair dryer.jpg}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{.45\textwidth}
      ...
      \includegraphics[width=.72\textwidth]{Images/Tennis match referee.jpg}
    \end{subfigure}\hspace{.05\textwidth}
    \begin{subfigure}[t]{.45\textwidth}
      \centering
      \caption{Tennis match referee sitting behind}
      \includegraphics[width=.72\textwidth]{Images/Tennis match referee sitting behind.jpg}
    \end{subfigure}
  \end{figure}
\end{frame}
...
\begin{frame}{Back end}{Graphic representation}
  \centering
  \scalebox{.6}{\input{Figures/Tikz/Server.tex}}
\end{frame}
...
\begin{frame}{Gantt Chart}{Main activities}
  \centering
  \scalebox{.7}{\input{Figures/Tikz/Gantt.tex}}
\end{frame}
