...
\usepackage[nomain, acronym, nolangwarn, savewrites]{glossaries}
...
\DeclareAcronymList{basic, dl, main, losses, models, web}
\newglossary*{basic}{Basic}
\newglossary*{dl}{Deep Learning}
\newglossary*{main}{Main}
\newglossary*{losses}{Loss Functions}
\newglossary*{web}{Web Development}
