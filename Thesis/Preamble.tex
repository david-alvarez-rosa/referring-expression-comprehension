...
% \usepackage[backend=biber, citestyle=verbose, bibstyle=alphabetic]{biblatex}
...
\usepackage[toc, acronym, nomain, style=super]{glossaries}
...
\newcommand{\source}[1]{
  \vspace{-8pt}\caption*{\footnotesize\hfill{#1}\footnotemark}
}
