...
(see \vref{sec:datasets}), the directory containing the code of this thesis
(see \vref{sec:thesis}) and the website directory (see \vref{sec:website}).



\section{Code Directory}\label{sec:code}
...
\section{Datasets Directory}\label{sec:dataset}
...
\section{Thesis Directory}\label{sec:thesis}
...
\section{Utils Directory}\label{sec:utils}
...
\section{Website Directory}\label{sec:website}
